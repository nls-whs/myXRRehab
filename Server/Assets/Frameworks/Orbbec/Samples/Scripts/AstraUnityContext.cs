...
public class AstraInitializingEventArgs : EventArgs { }
public class AstraTerminatingEventArgs : EventArgs { }
...
public sealed class AstraUnityContext
{
    ...
    private void EnsureJavaActivity()
    {
        if (javaActivity == null)
        {
            ...
            javaActivity = new AndroidJavaObject("com.orbbec.astra.android.unity3d.AstraUnityAndroid");
            AndroidJavaClass UnityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer"); 
            AndroidJavaObject currentActivity = UnityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
            javaActivity.Call("init", currentActivity);
